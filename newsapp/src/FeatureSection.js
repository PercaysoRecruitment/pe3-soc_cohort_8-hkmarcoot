  ...
  return (
    <div className="feature-section">
      ...
      <div className="feature-block-container">
        <div className="feature-block feature-bg-blue">
        ...
        <div className="feature-block feature-bg-orange">
          <div className="feature-block-text">
            <h4>News Articles Data</h4>
            <p>
              We use advanced extraction techniques to retrieve the different
              attributes that make up an article. Data quality is our number one
              concern and we do absolutely everything we can to ensure that it
              is always excellent.
            </p>
          </div>
        </div>
        ...
        <div className="feature-block feature-bg-green">
          <div className="feature-block-text">
        ...
        <div className="feature-block feature-bg-green">
          <div className="feature-block-text">
            <h4>Historic Data</h4>
            <p>
              The articles stored in our database are never deleted which allows
              you to consult through the API the history of published articles
